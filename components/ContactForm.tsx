          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#3CB043] focus:border-transparent transition-colors resize-none"
            ...
            <div className="text-center">
              <button
                type="submit"
                className="bg-[#3CB043] text-white font-semibold py-4 px-8 rounded-xl hover:bg-[#2D7A32] transition-colors duration-300 text-lg"
              >
                Send Message
              </button>
            </div>
