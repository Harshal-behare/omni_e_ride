      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-heading font-bold text-primary mb-4">OMNI E‑RIDE</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/models" className="text-gray-300 hover:text-primary transition">
                  Models
                </Link>
              </li>
              <li>
                <Link href="/dealers" className="text-gray-300 hover:text-primary transition">
                  Dealers
                </Link>
              </li>
              <li>
